...
FALLBACKS = [
    ...
    "A brutal melee ensues, with heavy losses on both sides.",
    "Banners fall and horns sound as the lines meet in a chaotic fray.",
    "The fortunes of war are fickle this day.",
]
